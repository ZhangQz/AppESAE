...
class DocumentoController1 extends Controller
{
	...
	public function store(Request $dados) {
		$documento = Documento::create($dados->all()); //cria o veículo com os dados do formulário (utilizei a facade Request)
	...
	public function show($id) {
		$documento = Documento::findOrFail($id); //retorna o veículo a mostrar
