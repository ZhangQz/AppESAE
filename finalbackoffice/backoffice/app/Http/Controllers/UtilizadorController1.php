...
class UtilizadorController1 extends Controller
{
	...
	public function store(Request $dados) {
		$utilizador = Utilizador::create($dados->all()); //cria o veículo com os dados do formulário (utilizei a facade Request)
	...
	public function show($id) {
		$utilizador = Utilizador::findOrFail($id); //retorna o veículo a mostrar
		$utilizador->curso = Curso::find($utilizador->curso);
